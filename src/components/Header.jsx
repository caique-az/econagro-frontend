...
function Header() {
  ...
  return (
    <div className="flex flex-col w-full z-50">
        ...
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex space-x-6">
            <span className="flex items-center hover:text-white transition-colors cursor-default">
              <FontAwesomeIcon icon={faPhone} className="mr-2" /> (19)
              99618-8008
            </span>
            <span className="flex items-center hover:text-white transition-colors cursor-default">
              <FontAwesomeIcon icon={faEnvelope} className="mr-2" />{" "}
              contato@econagro.com
            </span>
          </div>
      ...
      {/* Main Header - Sticky */}
      <header
        className={`w-full transition-all duration-300 ${isScrolled ? "sticky top-0 shadow-lg bg-primary/95 backdrop-blur-sm py-2" : "bg-primary py-4 relative"}`}
      >
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center">
            ...
            <Link
              href="/"
              className="flex items-center text-2xl md:text-3xl font-bold text-white no-underline hover:text-green-100 transition-colors group"
            >
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              <Link
                href="/carrinho"
                className="group flex items-center text-white hover:text-accent transition-colors relative no-underline bg-white/10 p-3 rounded-full hover:bg-white/20"
              >
        ...
        >
          <div className="px-4 pb-6 pt-2 bg-primary space-y-4 shadow-xl border-t border-white/10">
            ...
            <nav className="flex flex-col space-y-1 pt-2">
              <h3 className="text-white/50 text-xs font-bold uppercase tracking-wider mb-2 px-2">
                Navegação
              </h3>

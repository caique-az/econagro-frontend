  ...
  const teamMembers = [
    {
      ...
      image:
        "https://ui-avatars.com/api/?name=Caique+Azevedo&background=17A354&color=fff&size=150",
    ...
    },
    {
      ...
      image:
        "https://ui-avatars.com/api/?name=Viviane+Reis&background=17A354&color=fff&size=150",
    ...
    },
    {
      ...
      image:
        "https://ui-avatars.com/api/?name=Gabriel+Carvalho&background=17A354&color=fff&size=150",
  ...
  const features = [
    {
      ...
      description:
        "Soluções que promovem práticas agrícolas sustentáveis e responsáveis.",
    },
    {
      icon: faChartLine,
      title: "Análise de Dados",
      description:
        "Tomada de decisões baseada em dados precisos e em tempo real.",
    },
    {
      icon: faHandsHelping,
      title: "Suporte Especializado",
      description:
        "Equipe técnica altamente qualificada para atender suas necessidades.",
    },
  ];
      ...
      <section className="bg-primary text-white py-24 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl opacity-90">
            Conectando o campo às inovações tecnológicas para um futuro mais
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-dark border-l-4 border-primary pl-4">
              Nossa História
            </h2>
            <p className="text-gray-600 leading-relaxed">
              Fundada em 2023, a EconAgro nasceu da paixão por tecnologia e
              agricultura. Nossa jornada começou com o objetivo de simplificar a
              vida no campo através de soluções inovadoras que integram
              tecnologia de ponta com o conhecimento tradicional do agronegócio.
            </p>
            <p className="text-gray-600 leading-relaxed">
              Acreditamos que a tecnologia deve ser acessível a todos os
              produtores, independentemente do tamanho de sua propriedade. Por
              isso, desenvolvemos ferramentas intuitivas e eficientes que
              realmente fazem a diferença no dia a dia do campo.
            </p>
          </div>
          ...
          <div className="order-1 md:order-2 space-y-8">
            <div>
              ...
              <p className="text-gray-600">
                Potencializar a produtividade e sustentabilidade no campo
                através de soluções tecnológicas inovadoras, acessíveis e fáceis
                de usar.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                ...
                contribuindo para uma produção agrícola mais eficiente e
                sustentável.
              </p>
            </div>
        ...
        <section className="mb-24">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Profissionais apaixonados por tecnologia e agricultura dedicados a
              transformar o setor
            </p>
          </div>
        ...
        <div className="bg-secondary rounded-3xl p-12 text-center text-white shadow-xl relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              ...
              crescer com nossas soluções tecnológicas
            </p>
            <Link
              href="/talktous"
              className="inline-block bg-white text-primary font-bold py-4 px-10 rounded-full hover:bg-gray-100 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1 no-underline"
            >
              Fale Conosco
            </Link>
          </div>
